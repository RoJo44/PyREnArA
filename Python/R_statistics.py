...
def GMM(directory, directory_to_data):
    ...
    return GMM_function(directory, directory_to_data)
...
def RDA_clust(directory, directory_to_data, parameter, clust):
    
    import rpy2.robjects as robjects
    
    r = robjects.r
    r.source('../R/RDA_clust.R')
    
    RDA_function = robjects.globalenv['RDA_clust_function']
    
    return RDA_function(directory, directory_to_data, parameter, clust)
